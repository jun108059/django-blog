...
![img](../.vuepress/public/images/django-06.png)
...
![img](../.vuepress/public/images/django-07.png)  

![img](../.vuepress/public/images/django-05.png)
...
![img](../.vuepress/public/images/django-02.png)
...
![img](../.vuepress/public/images/django-08.png)
...
![img](../.vuepress/public/images/django-09.png)
...
![img](../.vuepress/public/images/django-10.png)

**✔게시글 예쁘게 띄워주기**

코드를 다음과 같이 수정해주면 됩니다.
...
```HTML
        {% for post in posts.all %}
            <div class="container">
                <h1>{{ post.title }}</h1>
                <p>{{ post.pub_date }}</p>
                <p>{{ post.summary }}<a href="{% url 'detail' post.id %}">....more</a></p>
            </div>
        {% endfor %}
```

![img](../.vuepress/public/images/django-11.png)

detail이 잘 보인다.

![img](../.vuepress/public/images/django-13.png)
![img](../.vuepress/public/images/django-12.png)
...
![img](../.vuepress/public/images/django-14.png)
![img](../.vuepress/public/images/django-15.png)
